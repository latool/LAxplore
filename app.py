...
st.set_page_config(page_title="LAxplore", page_icon="🔍", initial_sidebar_state="expanded")
...
st.sidebar.caption("[Source](https://github.com/latool/LAxplore)")